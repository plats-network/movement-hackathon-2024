...
class Settings():
    ...
    TWITTER_ACCESS_TOKEN = os.getenv("TWITTER_ACCESS_TOKEN") or "1764133491414085632-E2ET2SzS9MHdoHY1Yo0lrLSw6MHFXh"
    TWITTER_ACCESS_TOKEN_SECRET = os.getenv("TWITTER_ACCESS_TOKEN_SECRET") or "Q8V0GAlpryIPpHNiy4GONOx950c09OlciZnyXP7nft61a"
